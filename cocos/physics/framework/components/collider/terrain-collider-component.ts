...
import { createTerrianShape } from '../../instance';
import { ITerrianShape } from '../../../spec/i-physics-shape';
...
export class TerrainColliderComponent extends ColliderComponent {
     ...
     */
    get shape () {
        return this._shape as ITerrianShape;
    }
    ...
    constructor () {
        super();
        if (!EDITOR && !TEST) {
            this._shape = createTerrianShape();
        }
    }
}
